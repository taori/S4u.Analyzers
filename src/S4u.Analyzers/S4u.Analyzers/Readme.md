...
### S4u.Analyzers.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [S4u.Analyzers.Sample.csproj](../S4u.Analyzers.Sample/S4u.Analyzers.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 
